...
→ [Day 1 Foundation](diagrams/from-detection-to-investigation-day-2-overview-001.svg)
...
* Investigate cloud security events using AI
...
* Design complete cloud detection pipelines
...
→ [Why SIEM Systems Exist](diagrams/what-is-a-security-information-and-event-management-siem-system-009.svg)

With a SIEM:

→ [Why SIEM Systems Exist](diagrams/what-is-a-security-information-and-event-management-siem-system-010.svg)
...
→ [Cloud-Native SIEM on AWS](diagrams/what-is-a-security-information-and-event-management-siem-system-015.svg)
...
→ [Modern AI-Enhanced SIEM](diagrams/what-is-a-security-information-and-event-management-siem-system-016.svg)
...
→ [Step 2: Analyze](diagrams/siem-security-information-and-event-management-020.svg)
...
→ [Modern AI-Enhanced SIEM](diagrams/siem-security-information-and-event-management-025.svg)

AI-Enhanced SIEM:

→ [Modern AI-Enhanced SIEM](diagrams/siem-security-information-and-event-management-026.svg)

AI can help:

* Summarize large log volumes
* Explain alerts
* Correlate evidence
...
→ [Cloud-Native Monitoring](diagrams/cloud-native-monitoring-vs-traditional-siems-028.svg)
...
* Works directly on CloudWatch data
...
* Pay only for usage
* Easier budgeting for smaller environments
...
→ [Step 3 — Agent Tails the File](diagrams/amazon-cloudwatch-key-components-036.svg)
...
→ [Command 1 — fields](diagrams/cloudwatch-logs-insights-query-language-038.svg)
...
* More focus on analysis rather than syntax
...
* May use incorrect fields
* May miss relevant log sources
* May produce overly broad searches
* May misunderstand environment-specific formats
...
→ [Step 2 — Automated Analysis](diagrams/investigation-lifecycle-045.svg)
...
→ [Traditional Investigation Approach](diagrams/investigation-lifecycle-047.svg)
...
* Compare activity against real-world attack patterns
...
* EC2 instances generate logs
* CloudWatch Agent ships logs
* CloudWatch stores and analyzes logs
* AI Operations investigates findings
...
→ [Cost Control](diagrams/iam-roles-for-cloudwatch-access-required-roles-056.svg)
...
* Export or archive logs to Amazon S3
* Lower storage costs
* Supports compliance and audit requirements

Example:

→ [Typical SOC Strategy](diagrams/iam-roles-for-cloudwatch-access-required-roles-059.svg)
...
→ [Investigation Scope Matters](diagrams/iam-roles-for-cloudwatch-access-required-roles-062.svg)
...
→ [Diagram 64](diagrams/iam-roles-for-cloudwatch-access-required-roles-064.svg)
...
→ [Analyst Drill-Down](diagrams/iam-roles-for-cloudwatch-access-required-roles-066.svg)
...
→ [Principle 4: Alert Integration](diagrams/iam-roles-for-cloudwatch-access-required-roles-067.svg)
...
* Top IAM Access Denied Events
* GuardDuty Findings by Severity
* Active AI Operations Investigations
...
→ [Why Raw Logs Cannot Trigger Alarms](diagrams/iam-roles-for-cloudwatch-access-required-roles-069.svg)
...
→ [One Metric Filter, Multiple Consumers](diagrams/iam-roles-for-cloudwatch-access-required-roles-070.svg)
...
→ [Why This Architecture Matters](diagrams/iam-roles-for-cloudwatch-access-required-roles-073.svg)
...
* Which log events become metrics
* Which metrics trigger alarms
* Which alarms generate alerts
...
* Log formats vary slightly
* Application versions change wording
* Vendor products generate inconsistent messages
...
→ [Where Alarms Fit](diagrams/iam-roles-for-cloudwatch-access-required-roles-074.svg)
...
→ [Lambda Invocation](diagrams/iam-roles-for-cloudwatch-access-required-roles-076.svg)
...
→ [AI Operations Investigation](diagrams/iam-roles-for-cloudwatch-access-required-roles-077.svg)
...
* Newly created alarm
* New metric with limited history
...
→ [Slack / Teams](diagrams/iam-roles-for-cloudwatch-access-required-roles-079.svg)
...
→ [Lambda Function](diagrams/iam-roles-for-cloudwatch-access-required-roles-080.svg)
...
→ [AI Operations Investigation](diagrams/iam-roles-for-cloudwatch-access-required-roles-081.svg)
...
→ [Runbooks and AI Operations](diagrams/iam-roles-for-cloudwatch-access-required-roles-082.svg)
...
→ [Why Connect Alarms to AI Operations?](diagrams/iam-roles-for-cloudwatch-access-required-roles-083.svg)
...
→ [Automated AI Workflow](diagrams/iam-roles-for-cloudwatch-access-required-roles-084.svg)
...
→ [Example Scenario](diagrams/iam-roles-for-cloudwatch-access-required-roles-085.svg)
...
→ [Common Mistake](diagrams/iam-roles-for-cloudwatch-access-required-roles-086.svg)
...
→ [Why Privilege Escalation Matters](diagrams/iam-roles-for-cloudwatch-access-required-roles-087.svg)
...
→ [Diagram 88](diagrams/detection-strategy-088.svg)
...
* Is the host sensitive?
* Were commands successful?
* Were multiple hosts affected?
* Did other suspicious activity occur before or after?
...
→ [Instructor Demonstration](diagrams/detection-strategy-089.svg)
...
→ [Why Attackers Love SetUID](diagrams/detection-strategy-090.svg)
...
→ [Example Detection Workflow](diagrams/detection-strategy-091.svg)
...
→ [Instructor Demonstration](diagrams/detection-strategy-092.svg)
...
→ [Real Attack Lifecycle](diagrams/what-is-a-purple-team-093.svg)
...
→ [Red Team Perspective](diagrams/what-is-a-purple-team-094.svg)
...
→ [Why Dashboards Matter](diagrams/what-is-a-purple-team-096.svg)
...
* Use metric filters as data sources
* Keep widgets focused
* Standardize time ranges
* Display active alarms prominently
* Link dashboards to investigation workflows
* Regularly remove unused widgets
...
→ [Relationship Between Widgets](diagrams/what-is-a-purple-team-099.svg)
...
→ [Panel 3](diagrams/the-three-panel-soc-dashboard-100.svg)
...
→ [Why Detection Pipelines Matter](diagrams/the-three-panel-soc-dashboard-102.svg)
...
→ [Step 3 – CloudWatch Agent Ships Logs](diagrams/the-three-panel-soc-dashboard-103.svg)
...
* Typo in filter pattern
* Wrong field name
* Incorrect assumptions about log format
...
* SNS integration issue
* AI Operations workflow issue
...
* After CloudWatch modifications
* After agent updates
...
→ [Validation Workflow](diagrams/the-three-panel-soc-dashboard-107.svg)
...
→ [Detection Engineering in the SOC](diagrams/detection-engineering-vs-incident-response-109.svg)
...
→ [Building a Detection](diagrams/detection-engineering-vs-incident-response-110.svg)
...
→ [Detection Lifecycle](diagrams/detection-engineering-vs-incident-response-111.svg)
...
→ [Translating Threat Intelligence into Detections](diagrams/detection-engineering-vs-incident-response-112.svg)
...
→ [Testing Detection Rules](diagrams/detection-engineering-vs-incident-response-113.svg)
...
* Has log format changed?
* Are attackers using new techniques?
* Are analysts finding value in the alert?
...
→ [Why Documentation Matters](diagrams/detection-engineering-vs-incident-response-114.svg)
...
→ [In Our Lab Environment](diagrams/detection-engineering-vs-incident-response-115.svg)
...
* Millions of log events
* Thousands of potential attack paths
* Hundreds of ATT&CK techniques
* Continuous infrastructure changes

Attempting to detect every possible threat usually creates:

→ [The Reality of Detection Engineering](diagrams/detection-engineering-vs-incident-response-116.svg)
...
→ [Factor 3: Visibility](diagrams/detection-engineering-vs-incident-response-117.svg)
...
→ [Why Fidelity Matters](diagrams/detection-engineering-vs-incident-response-118.svg)

High fidelity creates:

→ [Why Fidelity Matters](diagrams/detection-engineering-vs-incident-response-119.svg)
...
→ [What Is a Threat Catalog?](diagrams/detection-engineering-vs-incident-response-120.svg)

## Why Create a Threat Catalog?

Without a threat catalog:

→ [Why Create a Threat Catalog?](diagrams/detection-engineering-vs-incident-response-121.svg)

With a threat catalog:

→ [Why Create a Threat Catalog?](diagrams/detection-engineering-vs-incident-response-122.svg)
...
→ [Threat-to-Detection Workflow](diagrams/detection-engineering-vs-incident-response-123.svg)
...
→ [How auditd Works](diagrams/detection-engineering-vs-incident-response-124.svg)
...
→ [auditd and CloudWatch](diagrams/detection-engineering-vs-incident-response-125.svg)
...
→ [Integration with CloudWatch](diagrams/detection-engineering-vs-incident-response-126.svg)
...
→ [Why Attackers Abuse setUID](diagrams/detection-engineering-vs-incident-response-127.svg)
...
* setGID abuse
* sudo abuse
* other privilege elevation methods
...
→ [Detecting Credential Harvesting](diagrams/detection-engineering-vs-incident-response-128.svg)
...
* Credential dumping
* Sensitive authentication data collection
...
→ [Example Detection Logic](diagrams/detection-engineering-vs-incident-response-129.svg)
...
→ [Why This Slide Matters](diagrams/detection-engineering-vs-incident-response-130.svg)
...
→ [Real-World Example](diagrams/detection-engineering-vs-incident-response-133.svg)
...
→ [The Detection Engineering Workflow](diagrams/detection-engineering-vs-incident-response-134.svg)
...
* Knows the correct credentials
* Has authorized access
* Performs elevation occasionally

An attacker may:

* Guess passwords
* Try repeatedly
* Attempt privilege escalation unexpectedly
...
→ [End-to-End Detection Flow](diagrams/detection-engineering-vs-incident-response-135.svg)
...
→ [Detection Engineering Principle](diagrams/detection-engineering-vs-incident-response-136.svg)
...
* CloudWatch receives the log
* metric filters match correctly
* metrics increment properly
* alarms trigger as expected
* investigations are created
...
→ [Common Mistake](diagrams/detection-engineering-vs-incident-response-137.svg)
...
→ [Typical Workflow](diagrams/detection-engineering-vs-incident-response-138.svg)
...
→ [Professional Detection Engineering Mindset](diagrams/detection-engineering-vs-incident-response-139.svg)
...
→ [Detection Engineer Workflow](diagrams/detection-engineering-vs-incident-response-140.svg)
...
* Did the alert detect the attack?
...
* Was containment performed quickly?
* Were SLAs met?
...
A finished report may look like:
...
→ [Real-World SOC Workflow](diagrams/detection-engineering-vs-incident-response-141.svg)
...
→ [AI + Human Analyst Model](diagrams/detection-engineering-vs-incident-response-142.svg)
...
* Which attack techniques can we detect?
* Which techniques can we partially detect?
* Which techniques are completely invisible?
...
→ [Identifying a Detection Gap](diagrams/detection-engineering-vs-incident-response-143.svg)
...
→ [Continuous Improvement Cycle](diagrams/detection-engineering-vs-incident-response-145.svg)
...
* Does the alert fire?
* Does it generate the expected metric?
* Does the alarm trigger?
* Does the investigation start correctly?
* Does the analyst receive enough context?
...
→ [Why Testing Matters](diagrams/detection-engineering-vs-incident-response-146.svg)
...
→ [Understanding False Positives](diagrams/detection-engineering-vs-incident-response-147.svg)

Examples include:

* Administrators performing maintenance
...
→ [Continuous Detection Improvement](diagrams/detection-engineering-vs-incident-response-149.svg)
...
* Record the analyst's conclusion
* Preserve evidence
* Support compliance requirements
* Improve future detections
* Enable lessons learned
...
* Credential theft
* Malware execution
* Sensitive file access by an attacker
...
→ [Reflect on What You Built](diagrams/detection-engineering-vs-incident-response-151.svg)
...
* Determine whether activity is malicious or benign
...
* Evaluate impact
* Record evidence
* Close investigations correctly
