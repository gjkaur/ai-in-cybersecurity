# Slide Topic: What is Cybersecurity?
...
Private Data      Accurate Data    Accessible Systems
```
...
# Slide Topic: The Modern Threat Landscape
...
```text
      ...
      Employees     Cloud     APIs     SaaS     Mobile
...
# Slide Topic: Cloud Computing and the New Perimeter
...
# Slide Topic: Shared Responsibility Model (Deep Dive)
...
# Slide Topic: AWS and Cloud Infrastructure
...
AI-assisted investigations and analysis.
...
Because modern organizations store:
...
# Slide Topic: AWS Regions, Availability Zones, IAM, VPC, and EC2
...
# Slide Topic: IAM Roles, Least Privilege, EC2, VPC and S3 Access
...
# Slide Topic: Virtual Machines and EC2 Instances
...
# Slide Topic: Launching EC2 Instances Safely
...
Because convenience creates risk.
...
# Slide Topic: SSH Key-Based Authentication
...
Sharing one key among entire team.
...
# Slide Topic: Navigating the Linux Filesystem
...
# Slide Topic: Linux File Permissions
...
# Slide Topic: SetUID Binaries and Privilege Risk
...
# Slide Topic: Finding and Investigating SetUID Binaries
...
# Slide Topic: Security Groups as Firewalls
...
# Slide Topic: Running and Securing a Web Service
...
# Slide Topic: The SOC Analyst Role
...
# Slide Topic: The Cyber Kill Chain
...
```text
AI Analyzes Millions of Events
↓
...
```text
AI reviews millions of events
↓
Maps behavior to ATT&CK techniques
↓
Prioritizes high-risk attacks
↓
Analyst investigates
```
...
```text
Because logs provide the evidence
...
```text
journald collects logs from system services,
...
Logs may also be forwarded into:
...
Modern Large Language Models (LLMs) can assist with:
...
Need Custom Script
       ↓
AI Assistant Generates Draft
       ↓
Analyst Reviews & Tests
       ↓
Production Use
```
...
Many security frameworks require least-privilege access:
...
Applications may depend on permissions accumulated over many years.
...
Attacker Executes Code
           ↓
Steals Temporary Credentials
           ↓
Uses Execution Role Permissions
           ↓
Accesses Sensitive AWS Resources
```
...
```text
Compromised User or Application
            ↓
    IAM Permissions
            ↓
Privilege Escalation
            ↓
Data Access or Service Control
            ↓
Cloud Account Impact
```
...
Unused accounts are attractive targets because:
...
Excessive permissions can expose:
...
AI Analysis
      ↓
Potentially Manipulated Result
```
...
AWS-recommended security controls covering:
...
Attackers attempting to discover AWS resources:
...
Repeated connection attempts to multiple systems:
...
Never implement a change without understanding:
...
S3 Bucket Private
      ↓
Day 20
Developer Changes Policy
      ↓
Bucket Becomes Public
      ↓
Security Finding Reappears
```
