...
Timestamp                  Message
------------------------------------------------
2026-06-10 12:01:00        Failed password...
2026-06-10 12:02:15        Failed password...
```
...
100,000 log events
        ↓
250 authentication failures
        ↓
25 suspicious events
```
...
Enable AI Operations
      ↓
Auto-Create Service Role
      ↓
AWS Creates Required Permissions
```
...
Detection Engineer
     ↓
Creates Rule:
Failed sudo attempts > threshold
...
Low-privileged user
       ↓
Launches modified binary
       ↓
Obtains elevated privileges
```
...
Alarm triggers
        ↓
AI Operations investigation created
        ↓
...
Technique                        Status
-----------------------------------------
SSH Brute Force                  Covered
Sensitive File Reads             Covered
Account Creation                 Covered
Cron Persistence                 Partial
Service Creation                 Partial
Data Exfiltration                Not Covered
