...
flowchart TB
    ...
    subgraph P1["Phase 1 · AWS (~20 min)"]
        direction LR
        S1["Step 1<br/>Create SSH key"]
        S2["Step 2<br/>Launch EC2"]
        S3["Step 3<br/>Get public IP"]
        S1 --> S2 --> S3
    end
    ...
    subgraph P2["Phase 2 · Connect (~10 min)"]
        direction LR
        S4["Step 4<br/>VS Code SSH config"]
        S5["Step 5<br/>Connect to EC2"]
        S4 --> S5
    end
    ...
    subgraph P3["Phase 3 · Linux (~15 min)"]
        direction LR
        S6["Step 6<br/>Files & scripts"]
        S7["Step 7<br/>SetUID inventory"]
        S6 --> S7
    end
    ...
    subgraph P4["Phase 4 · Web (~15 min)"]
        S8["Step 8<br/>nginx + access logs"]
    end
    ...
    style P2 fill:#ECFDF5,stroke:#16A34A
    style P3 fill:#FFFBEB,stroke:#D97706
