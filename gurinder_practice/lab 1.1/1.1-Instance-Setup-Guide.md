...
| 5 | Connect to EC2 |
| 6 | Linux script (`chmod`) |
| 7 | SetUID find |
| 8 | nginx + browser test |
...
<details>
<summary>Console instead of CloudShell</summary>

**EC2 → Key Pairs → Create key pair** · Name `soc-lab-key` · RSA · `.pem` · Download.
...
<details>
<summary>Console launch wizard</summary>

**EC2 → Launch Instance** · Amazon Linux 2023 · `t2.medium` · key `soc-lab-key` · allow **SSH** and **HTTP** from `0.0.0.0/0`.
...
- IP changes after stop/start → update VS Code config  
- Security group must allow TCP **22** and **80**
