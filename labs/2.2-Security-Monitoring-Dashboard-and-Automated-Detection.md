...
![Lab 2.2 detection pipeline — log groups through metric filters, alarms, and AI Operations](/labs/images/lab-2.2-detection-pipeline.svg)
...
4. For **Filter pattern**, enter:
   ...
   ![Metric filter pattern entered in the filter pattern field](/labs/images/log-filter-metric.png)
...
7. Set the following:
   ...
   ![Metric details — namespace, metric name, and value fields](/labs/images/metric-details.png)
...
![Add widget dialog — select Metrics data type and Line chart widget type](/labs/images/new-widget.png)
...
![Add widget dialog — select Logs data type and Logs table widget type](/labs/images/log-widget.png)
...
![Query Generator panel — enter a natural-language prompt to generate a Logs Insights query](/labs/images/Generate-new-query.png)
